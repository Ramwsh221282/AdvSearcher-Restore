...
namespace AdvSearcher.Parser.SDK.WebDriverParsing.CommonCommands.ScrollToBottom;

public sealed class ScrollToBottomCommand
    : WebDriverCommand,
        IWebDriverCommand<ScrollToBottomCommand>
{
