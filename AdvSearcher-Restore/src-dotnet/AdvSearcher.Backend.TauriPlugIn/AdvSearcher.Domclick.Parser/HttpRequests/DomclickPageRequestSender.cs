...
using AdvSearcher.Domclick.Parser.DomclickWebDriver.Queries;
...
namespace AdvSearcher.Domclick.Parser.HttpRequests;

public sealed class DomclickPageRequestSender
{
