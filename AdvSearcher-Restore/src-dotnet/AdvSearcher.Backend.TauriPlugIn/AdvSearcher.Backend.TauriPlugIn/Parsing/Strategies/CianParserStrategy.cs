...
public sealed class CianParserStrategy : IParsingStrategy
{
    ...
    private const string ParserName = "CianParser";

    public CianParserStrategy(
    ...
    {
        IEnumerable<ServiceUrl> urls = await _factory.GetAllLoadableServiceUrlsOfService("CIAN");
