...
internal sealed class AvitoFastPublisherOnlyFiltering : IParserFilterVisitor
{
    private readonly string _publisher;

    public AvitoFastPublisherOnlyFiltering(string publisher) => _publisher = publisher;
